...
- **상태**: **적용됨**(green·미러 11/11·양판 IDENTICAL)
...
- **한 줄 결론**:
- ⚠️ N=1 인과 단정 금지 — "처방 020이 96 인용을 *유발*"이 아니라 "020 적용 후 16차 codex 96 인용 관찰". claude는 이미 96(직독)이라 변별은 codex 단독 — 자발 변동 가능성 상존(실측 확인).
