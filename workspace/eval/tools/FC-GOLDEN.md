...
> **시나리오 인스턴스(2026-06-20)**: 이 골든은 `SCENARIO-S1`(공지) 인스턴스다 — **골격(§0 사실·§1 골든표·§2 mutation·§3 실행어댑터·§4 동결)은 시나리오 중립**이며, 새 시나리오는 `FC-GOLDEN-<시나리오>`로 같은 골격을 따른다(예: `FC-GOLDEN-WEATHER`). 내부 행위표는 시나리오 고유(정상 격리).
